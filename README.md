...
### Gallery
- [`cubege`](https://keyframes.babb.dev)<img src="assets/cube.png" style="vertical-align: middle">
...
- [offical NC speedtest implementation demo](https://www.go.ncsu.edu/mbabb) — used for broadband analysis and novel speedtest methodilogical testing
- [`go.ncsu.edu/sudoku`](https://www.go.ncsu.edu/sudoku) — implementation of my generalized CSP solver
...
-   [`fourier-analysis`](https://github.com/mkbabb/fourier-analysis) — Fourier analysis through linear algebra and complex analysis. Paper, Python library, and [interactive web demo](https://fourier.babb.dev) with epicycle decomposition, orthogonal basis visualization, and contour tracing.
